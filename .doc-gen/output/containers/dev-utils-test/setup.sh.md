...
**Path:** containers/dev-utils-test/setup.sh
**Syntax:** bash
...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/carolynboyle/dev-utils/main/containers/setup.sh | bash -s <container-name>
#
# Example:
#   curl -fsSL https://raw.githubusercontent.com/carolynboyle/dev-utils/main/containers/setup.sh | bash -s python-test
#   curl -fsSL https://raw.githubusercontent.com/carolynboyle/dev-utils/main/containers/setup.sh | bash -s dev-utils-test
#
...
# Constants
# -----------------------------------------------------------------------------
REPO_RAW="https://raw.githubusercontent.com/carolynboyle/dev-utils/main/containers"
REGISTRY_URL="${REPO_RAW}/containers.yaml"
